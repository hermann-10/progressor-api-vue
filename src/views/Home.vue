<template>
  <div class="home">
    ...
    <Form @createTask="addTask" /> <!-- "@" car on écoute l'événement createTask définit dans Form.vue, lorsque l'emission de cet événement arrive, on appel la fonction addTask -->
  </div>
</template>
